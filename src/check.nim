...
method configSchema*(this: CheckGenerator): Option[string] {.base.} =
  ## Returns the JSON-Schema for the configuration
  ## of the type of check generated by this.
  return none[string]()

method generate*(this: CheckGenerator, config: CheckConfig = CheckConfig(id: this.id()[0], json: none[string]())): Check {.base.} =
